$(function () {
    ...
    request.onOpen = function(response) {
        content.html($('<p>', { text: 'Welcome! Start chatting by entering your Name below.'}));
    ...
    request.onReopen = function(response) {
        input.removeAttr('disabled').focus();
        content.html($('<p>', { text: 'ChatApp re-connected using ' + response.transport }));
    };
    ...
    request.onTransportFailure = function(errorMsg, request) {
        ...
        header.html($('<h3>', { text: 'ChatApp! Default transport is WebSocket, fallback is ' + request.fallbackTransport }));
    };
    ...
    function addMessage(author, message, color, datetime) {
        content.append('<div style="border:1px solid #e1e1e1; margin: 5px; padding:5px; border-radius: 5px; background-color:#e1e1e1; width:540px;"><p><span style="color:' + color + '"><b>' + author + '</b></span> @ ' +
